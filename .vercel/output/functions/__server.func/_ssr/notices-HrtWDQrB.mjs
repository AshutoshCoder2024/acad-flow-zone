...
import { c as adminGetSignedUrl, i as adminDeleteNotice, n as adminCreateNotice, o as adminFetchNotices } from "./admin-api.functions-UHpZ8eZT.mjs";
...
import { t as fileToBase64 } from "./file-helpers-DyHmh4g0.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/notices-HrtWDQrB.js
...
function NoticesPage() {
	...
	const query = useQuery({
		...
		queryFn: async () => {
			if (isEnvAdmin && adminToken) return adminFetchNotices({ data: {
				token: adminToken,
				search,
				priority,
				page,
	...
	async function handleCreate(form, file, priorityValue) {
	...
	async function handleDelete(id, attachmentUrl) {
		if (!confirm("Delete this notice?")) return;
		if (isEnvAdmin && adminToken) {
			try {
				await adminDeleteNotice({ data: {
					token: adminToken,
					id,
					attachmentUrl
				} });
	...
	async function downloadAttachment(path, name) {
		if (isEnvAdmin && adminToken) {
			try {
				const signedUrl = await adminGetSignedUrl({ data: {
					token: adminToken,
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									variant: "ghost",
									size: "icon",
									onClick: () => handleDelete(n.id, n.attachment_url),
									"aria-label": "Delete",
